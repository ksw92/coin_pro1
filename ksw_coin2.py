...
stock = "xoxb-3566443758993-3574327487846-TMDrLdYj7Sv0ibiiYQb1aDlF"
coinN = "KRW-MANA"
tk = 0.5
...
sell_check = 0
time_check = 0
post_message(stock, "#stock", "--KSW AUTO COIN-2 START--")
print("--KSW AUTO COIN-2 START--")
################################################
    ...
    try:
            ...
            if 10 < current_time.minute < 30 :
                if target_price[1] < current_price:
                    ...
                    if float(korea_price) > 5000:
                        ...
                        post_message(stock, "#stock", "[JACKPOT-BUY] : %s \n Current Price : %s" % (coinN, current_price))
                        buy_check = 1
                    else:
        ...
        if buy_check == 1:
            if current_time.minute == 45:
                post_message(stock, "#stock", "[CHECK] MINUTE45]")
