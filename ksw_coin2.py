...
stock = "xoxb-3566443758993-3574327487846-XS2s4SXXQJPz6h0BUXbiwhnb"
coinN = "KRW-MANA"
tk = 0.4
...
while True:
    try:
        ...
        if buy_check == 1:
            time.sleep(5)
            if current_time.minute == 15 or current_time.minute == 35 or current_time.minute == 55:
